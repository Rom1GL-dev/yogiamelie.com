...
const SECTION = 'presentationCours';

const SiteWebPageCoursPresentation = observer(() => {
  ...
  useEffect(() => {
    (async () => {
      ...
      setFields({
        ...
        button: {
          id: null,
          value: sectionDetails?.details?.button || ''
        },
        buttonLink: {
          id: null,
...
export default SiteWebPageCoursPresentation;
