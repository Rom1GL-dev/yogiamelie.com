...
const SECTION = 'aboutCours';

const SiteWebPageCoursBienvenue = observer(() => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      showToast({
        type: 'success',
        message: 'Section "A propos" mise à jour avec succès !'
      });
...
export default SiteWebPageCoursBienvenue;
