...
export default function PolitiquedeConfidentialitePage() {
  return (
    <div className="min-h-screen bg-[#faf8f5]">
      ...
      {/* Header */}
      <div className="grain bg-[#353F34] px-6 pt-10 pb-12 md:px-10 md:pt-14 md:pb-16">
      ...
      <div className="mx-auto max-w-3xl px-6 py-12 md:py-16">
        <article className="max-w-none space-y-8 text-base leading-[1.8] text-[#2d3640] md:text-[17px]">
          <section>
            <h2 className="mb-3 text-2xl font-semibold text-[#353F34]">
              1. Introduction
            </h2>
            <p>
              ...
              <Link
                ...
                className="text-[#c08562] underline underline-offset-2"
              >
                keshariniyoga.com
              </Link>
          ...
          <section>
            ...
            <p>
              ...
              , veuillez contacter <strong>Kesharini Yoga</strong> à
              l&apos;adresse email suivante : hello@yogiamelie.be.
            </p>
          </section>
        </article>
      </div>
